...
- The dashboard custom post renders a non-scrolling inline launcher; full moderator History, Profile, Reversal, and Admin workflows load after `Open StrikeLedger` opens expanded mode.
