...
- Updated the Devvit package family to `0.13.8`.
- Dependency-only rebuild with no intended moderation behavior changes.

### 1.3.3 - 2026-07-04

- Updated the Devvit package family to `0.13.6`.
- Dependency-only rebuild with no intended moderation behavior changes.
